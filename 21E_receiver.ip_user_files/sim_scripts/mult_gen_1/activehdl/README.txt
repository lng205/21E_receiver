...
#
# Generated by export_simulation on Fri Nov 05 21:14:41 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './mult_gen_1.sh' script.

./mult_gen_1.sh -reset_run
...
./mult_gen_1.sh -noclean_files

For more information on the script, please type './mult_gen_1.sh -help'.
