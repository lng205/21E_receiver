...
#
# Generated by export_simulation on Sun Nov 07 17:19:16 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './mult_gen_2.sh' script.

./mult_gen_2.sh -reset_run
...
./mult_gen_2.sh -noclean_files

For more information on the script, please type './mult_gen_2.sh -help'.
